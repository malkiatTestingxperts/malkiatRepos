...
export class CustomerPage {
    ...
    get customerAccount() {
        return this.page.locator("[data-dyn-controlname='DynamicHeader'] input");
    }
    ...
    get enterGroup() {
        return this.page.locator('[data-dyn-controlname="DynamicDetail_CustGroup"] input');
    ...
    get mainAccount() {
        return this.page.locator('[data-dyn-controlname="CustInvoiceLine_LedgerAccount"] input');
    }
    ...
    async enterCustomerAccountNumber(supplierNumber: string) {
        ...
        await this.customerAccount.fill(supplierNumber);
    }
